...
import su.workbench.reallights.RealLightsMod;
...
public class ConfigHandler {
	...
	public static void registerConfig(FMLPreInitializationEvent event) {
		RealLightsMod.config = new File(event.getModConfigurationDirectory()+"/"+RealLightsMod.MODID);
		RealLightsMod.config.mkdirs();
		init(new File(RealLightsMod.config.getPath(), RealLightsMod.MODID + ".cfg"));
	}
}
