...
import su.workbench.reallights.block.BlockFluorescentLampCagedOn;
import su.workbench.reallights.ElementsRealLightsMod;

import java.util.Map;

@ElementsRealLightsMod.ModElement.Tag
public class ProcedureFluorescentLampCagedRedstoneOn extends ElementsRealLightsMod.ModElement {
	public ProcedureFluorescentLampCagedRedstoneOn(ElementsRealLightsMod instance) {
		super(instance, 4);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((new Object() {
			...
			world.setBlockState(new BlockPos((int) x, (int) y, (int) z), BlockFluorescentLampCagedOn.block.getDefaultState(), 3);
			try {
