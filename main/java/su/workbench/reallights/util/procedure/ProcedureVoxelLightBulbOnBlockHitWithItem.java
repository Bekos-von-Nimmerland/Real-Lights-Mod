...
public class ProcedureVoxelLightBulbOnBlockHitWithItem extends ElementsRealLightsMod.ModElement {
	public ProcedureVoxelLightBulbOnBlockHitWithItem(ElementsRealLightsMod instance) {
		super(instance, 27);
	}
