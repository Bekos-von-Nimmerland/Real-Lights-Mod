...
import su.workbench.reallights.block.BlockVoxelLightBulbOn;
import su.workbench.reallights.ElementsRealLightsMod;

import java.util.Map;

@ElementsRealLightsMod.ModElement.Tag
public class ProcedureVoxelLightBulbRedstoneOn extends ElementsRealLightsMod.ModElement {
	public ProcedureVoxelLightBulbRedstoneOn(ElementsRealLightsMod instance) {
		super(instance, 15);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure VoxelLightBulbRedstoneOn!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure VoxelLightBulbRedstoneOn!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure VoxelLightBulbRedstoneOn!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure VoxelLightBulbRedstoneOn!");
			return;
		}
		...
		if (((new Object() {
			...
			world.setBlockState(new BlockPos((int) x, (int) y, (int) z), BlockVoxelLightBulbOn.block.getDefaultState(), 3);
			try {
