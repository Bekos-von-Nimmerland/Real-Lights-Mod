...
import su.workbench.reallights.block.BlockVoxelLightBulbShattered;
import su.workbench.reallights.ElementsRealLightsMod;

import java.util.Map;

@ElementsRealLightsMod.ModElement.Tag
public class ProcedureVoxelLightBulbBlockHitWithItem extends ElementsRealLightsMod.ModElement {
	public ProcedureVoxelLightBulbBlockHitWithItem(ElementsRealLightsMod instance) {
		super(instance, 23);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure VoxelLightBulbBlockHitWithItem!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure VoxelLightBulbBlockHitWithItem!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure VoxelLightBulbBlockHitWithItem!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure VoxelLightBulbBlockHitWithItem!");
			return;
		}
		...
		if (((new Object() {
			...
			world.setBlockState(new BlockPos((int) x, (int) y, (int) z), BlockVoxelLightBulbShattered.block.getDefaultState(), 3);
			try {
