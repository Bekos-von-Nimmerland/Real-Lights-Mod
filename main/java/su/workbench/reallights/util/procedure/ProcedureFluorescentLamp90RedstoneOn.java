...
import su.workbench.reallights.block.BlockFluorescentLampOn90;
import su.workbench.reallights.ElementsRealLightsMod;

import java.util.Map;

@ElementsRealLightsMod.ModElement.Tag
public class ProcedureFluorescentLamp90RedstoneOn extends ElementsRealLightsMod.ModElement {
	public ProcedureFluorescentLamp90RedstoneOn(ElementsRealLightsMod instance) {
		super(instance, 25);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((new Object() {
			...
			world.setBlockState(new BlockPos((int) x, (int) y, (int) z), BlockFluorescentLampOn90.block.getDefaultState(), 3);
			try {
