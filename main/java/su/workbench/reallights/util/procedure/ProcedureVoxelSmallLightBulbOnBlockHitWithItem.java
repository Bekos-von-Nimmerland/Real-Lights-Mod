...
public class ProcedureVoxelSmallLightBulbOnBlockHitWithItem extends ElementsRealLightsMod.ModElement {
	public ProcedureVoxelSmallLightBulbOnBlockHitWithItem(ElementsRealLightsMod instance) {
		super(instance, 27);
	}
