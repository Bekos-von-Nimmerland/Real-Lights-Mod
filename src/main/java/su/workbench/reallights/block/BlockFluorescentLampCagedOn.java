...
import su.workbench.reallights.util.procedure.ProcedureFluorescentLampCagedOnRedstoneOff;
...
public class BlockFluorescentLampCagedOn extends ElementsRealLightsMod.ModElement {
	@GameRegistry.ObjectHolder("real_lights:fluorescent_lamp_caged_on")
	public static final Block block = null;
	public BlockFluorescentLampCagedOn(ElementsRealLightsMod instance) {
		super(instance, 2);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("fluorescent_lamp_caged_on"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("real_lights:fluorescent_lamp_caged_on", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.REDSTONE_LIGHT);
			setUnlocalizedName("fluorescent_lamp_caged_on");
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
			} else {
				{
					...
					ProcedureFluorescentLampCagedOnRedstoneOff.executeProcedure($_dependencies);
				}
			}
		}
		@Override
