...
public class BlockVoxelLightBulbShattered extends ElementsRealLightsMod.ModElement {
	@GameRegistry.ObjectHolder("real_lights:voxel_light_bulb_shattered")
	public static final Block block = null;
	public BlockVoxelLightBulbShattered(ElementsRealLightsMod instance) {
		super(instance, 22);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("voxel_light_bulb_shattered"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("real_lights:voxel_light_bulb_shattered", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.REDSTONE_LIGHT);
			setUnlocalizedName("voxel_light_bulb_shattered");
		...
		public AxisAlignedBB getCollisionBoundingBox(IBlockState blockState, IBlockAccess worldIn, BlockPos pos) {
	        switch (blockState.getValue(FACING))
	        {
	            case EAST:
	            default:
	                return VOXEL_LIGHT_BULB_SHATTERED_EAST_AABB;
	            case WEST:
	                return VOXEL_LIGHT_BULB_SHATTERED_WEST_AABB;
	            case SOUTH:
	                return VOXEL_LIGHT_BULB_SHATTERED_SOUTH_AABB;
	            case NORTH:
	                return VOXEL_LIGHT_BULB_SHATTERED_NORTH_AABB;
	            case UP:
	                return VOXEL_LIGHT_BULB_SHATTERED_UP_AABB;
	            case DOWN:
	                return VOXEL_LIGHT_BULB_SHATTERED_DOWN_AABB;
	        }
		}
