...
public class BlockVoxelSmallLightBulbShattered extends ElementsRealLightsMod.ModElement {
	@GameRegistry.ObjectHolder("real_lights:voxel_small_light_bulb_shattered")
	public static final Block block = null;
	public BlockVoxelSmallLightBulbShattered(ElementsRealLightsMod instance) {
		super(instance, 22);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("voxel_small_light_bulb_shattered"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation("real_lights:voxel_small_light_bulb_shattered", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.REDSTONE_LIGHT);
			setUnlocalizedName("voxel_small_light_bulb_shattered");
