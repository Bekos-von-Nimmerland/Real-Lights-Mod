...
import su.workbench.reallights.block.BlockLightBulbCracked;
import su.workbench.reallights.ElementsRealLightsMod;

import java.util.Map;

@ElementsRealLightsMod.ModElement.Tag
public class ProcedureLightBulbBlockHitWithItem extends ElementsRealLightsMod.ModElement {
	public ProcedureLightBulbBlockHitWithItem(ElementsRealLightsMod instance) {
		super(instance, 23);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((new Object() {
			...
			world.setBlockState(new BlockPos((int) x, (int) y, (int) z), BlockLightBulbCracked.block.getDefaultState(), 3);
			try {
