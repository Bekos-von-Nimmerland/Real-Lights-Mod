...
import su.workbench.reallights.block.BlockFluorescentLamp90;
import su.workbench.reallights.ElementsRealLightsMod;

import java.util.Map;

@ElementsRealLightsMod.ModElement.Tag
public class ProcedureFluorescentLampOn90RedstoneOff extends ElementsRealLightsMod.ModElement {
	public ProcedureFluorescentLampOn90RedstoneOff(ElementsRealLightsMod instance) {
		super(instance, 24);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure FluorescentLampOnRedstoneOff!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure FluorescentLampOnRedstoneOff!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure FluorescentLampOnRedstoneOff!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure FluorescentLampOnRedstoneOff!");
			return;
		}
		...
		if (((new Object() {
			...
			world.setBlockState(new BlockPos((int) x, (int) y, (int) z), BlockFluorescentLamp90.block.getDefaultState(), 3);
			try {
