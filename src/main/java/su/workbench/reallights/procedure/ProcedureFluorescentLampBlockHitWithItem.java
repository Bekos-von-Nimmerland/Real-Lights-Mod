...
import su.workbench.reallights.block.BlockFluorescentLampCracked;
...
public class ProcedureFluorescentLampBlockHitWithItem extends ElementsRealLightsMod.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((new Object() {
			...
			world.setBlockState(new BlockPos((int) x, (int) y, (int) z), BlockFluorescentLampCracked.block.getDefaultState(), 3);
			try {
