...
import su.workbench.reallights.block.BlockCagedLightBulbOn;
import su.workbench.reallights.ElementsRealLightsMod;

import java.util.Map;

@ElementsRealLightsMod.ModElement.Tag
public class ProcedureCagedLightBulbRedstoneOn extends ElementsRealLightsMod.ModElement {
	public ProcedureCagedLightBulbRedstoneOn(ElementsRealLightsMod instance) {
		super(instance, 9);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((new Object() {
			...
			world.setBlockState(new BlockPos((int) x, (int) y, (int) z), BlockCagedLightBulbOn.block.getDefaultState(), 3);
			try {
