...
import su.workbench.reallights.block.BlockVoxelSmallLightBulbOn;
import su.workbench.reallights.ElementsRealLightsMod;

import java.util.Map;

@ElementsRealLightsMod.ModElement.Tag
public class ProcedureVoxelSmallLightBulbRedstoneOn extends ElementsRealLightsMod.ModElement {
	public ProcedureVoxelSmallLightBulbRedstoneOn(ElementsRealLightsMod instance) {
		super(instance, 15);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure VoxelSmallLightBulbRedstoneOn!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure VoxelSmallLightBulbRedstoneOn!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure VoxelSmallLightBulbRedstoneOn!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure VoxelSmallLightBulbRedstoneOn!");
			return;
		}
		...
		world.playSound((EntityPlayer) null, x, y, z,
				(net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation("real_lights:bulb_lamp_turn_on")),SoundCategory.BLOCKS, 1.0F, 1.0F);
		if (((new Object() {
			...
			world.setBlockState(new BlockPos((int) x, (int) y, (int) z), BlockVoxelSmallLightBulbOn.block.getDefaultState(), 3);
			try {
