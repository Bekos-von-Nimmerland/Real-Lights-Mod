...
public class ProcedureFluorescentLampOn90BlockHitWithItem extends ElementsRealLightsMod.ModElement {
	public ProcedureFluorescentLampOn90BlockHitWithItem(ElementsRealLightsMod instance) {
		super(instance, 28);
	}
