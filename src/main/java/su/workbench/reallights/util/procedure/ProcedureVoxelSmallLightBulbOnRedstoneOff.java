...
import su.workbench.reallights.block.BlockVoxelSmallLightBulb;
import su.workbench.reallights.ElementsRealLightsMod;

import java.util.Map;

@ElementsRealLightsMod.ModElement.Tag
public class ProcedureVoxelSmallLightBulbOnRedstoneOff extends ElementsRealLightsMod.ModElement {
	public ProcedureVoxelSmallLightBulbOnRedstoneOff(ElementsRealLightsMod instance) {
		super(instance, 14);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure VoxelSmallLightBulbOnRedstoneOff!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure VoxelSmallLightBulbOnRedstoneOff!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure VoxelSmallLightBulbOnRedstoneOff!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure VoxelSmallLightBulbOnRedstoneOff!");
			return;
		}
		...
		if (((new Object() {
			...
			world.setBlockState(new BlockPos((int) x, (int) y, (int) z), BlockVoxelSmallLightBulb.block.getDefaultState(), 3);
			try {
