...
import su.workbench.reallights.block.BlockFluorescentLamp;
import su.workbench.reallights.ElementsRealLightsMod;

import java.util.Map;

@ElementsRealLightsMod.ModElement.Tag
public class ProcedureFluorescentLampOnRedstoneOff extends ElementsRealLightsMod.ModElement {
	public ProcedureFluorescentLampOnRedstoneOff(ElementsRealLightsMod instance) {
		super(instance, 3);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((new Object() {
			...
			world.setBlockState(new BlockPos((int) x, (int) y, (int) z), BlockFluorescentLamp.block.getDefaultState(), 3);
			try {
