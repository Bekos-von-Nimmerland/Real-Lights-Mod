...
public class ProcedureFluorescentLampOnBlockHitWithItem extends ElementsRealLightsMod.ModElement {
	public ProcedureFluorescentLampOnBlockHitWithItem(ElementsRealLightsMod instance) {
		super(instance, 29);
	}
