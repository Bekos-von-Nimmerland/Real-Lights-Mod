...
import su.workbench.reallights.block.BlockVoxelSmallLightBulbShattered;
import su.workbench.reallights.ElementsRealLightsMod;

import java.util.Map;

@ElementsRealLightsMod.ModElement.Tag
public class ProcedureVoxelSmallLightBulbBlockHitWithItem extends ElementsRealLightsMod.ModElement {
	public ProcedureVoxelSmallLightBulbBlockHitWithItem(ElementsRealLightsMod instance) {
		super(instance, 23);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure VoxelSmallLightBulbBlockHitWithItem!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure VoxelSmallLightBulbBlockHitWithItem!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure VoxelSmallLightBulbBlockHitWithItem!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure VoxelSmallLightBulbBlockHitWithItem!");
			return;
		}
		...
		world.playSound((EntityPlayer) null, x, y, z,
				(net.minecraft.util.SoundEvent) net.minecraft.util.SoundEvent.REGISTRY.getObject(new ResourceLocation("real_lights:lamp_off_break")),SoundCategory.BLOCKS, 1.0F, 1.0F);
		if (((new Object() {
			...
			world.setBlockState(new BlockPos((int) x, (int) y, (int) z), BlockVoxelSmallLightBulbShattered.block.getDefaultState(), 3);
			try {
