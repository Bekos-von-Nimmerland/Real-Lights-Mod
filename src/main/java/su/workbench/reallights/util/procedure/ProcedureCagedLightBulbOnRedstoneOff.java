...
import su.workbench.reallights.block.BlockCagedLightBulb;
import su.workbench.reallights.ElementsRealLightsMod;

import java.util.Map;

@ElementsRealLightsMod.ModElement.Tag
public class ProcedureCagedLightBulbOnRedstoneOff extends ElementsRealLightsMod.ModElement {
	public ProcedureCagedLightBulbOnRedstoneOff(ElementsRealLightsMod instance) {
		super(instance, 10);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((new Object() {
			...
			world.setBlockState(new BlockPos((int) x, (int) y, (int) z), BlockCagedLightBulb.block.getDefaultState(), 3);
			try {
