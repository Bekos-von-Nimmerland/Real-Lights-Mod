...
import su.workbench.reallights.block.BlockFluorescentLampShattered;
import su.workbench.reallights.ElementsRealLightsMod;

import java.util.Map;

@ElementsRealLightsMod.ModElement.Tag
public class ProcedureFluorescentLampBlockHitWithItem extends ElementsRealLightsMod.ModElement {
	public ProcedureFluorescentLampBlockHitWithItem(ElementsRealLightsMod instance) {
		super(instance, 6);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((new Object() {
			...
			world.setBlockState(new BlockPos((int) x, (int) y, (int) z), BlockFluorescentLampShattered.block.getDefaultState(), 3);
			try {
