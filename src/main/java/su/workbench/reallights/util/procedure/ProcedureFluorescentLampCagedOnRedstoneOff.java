...
import su.workbench.reallights.block.BlockFluorescentLampCaged;
import su.workbench.reallights.ElementsRealLightsMod;

import java.util.Map;

@ElementsRealLightsMod.ModElement.Tag
public class ProcedureFluorescentLampCagedOnRedstoneOff extends ElementsRealLightsMod.ModElement {
	public ProcedureFluorescentLampCagedOnRedstoneOff(ElementsRealLightsMod instance) {
		super(instance, 3);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((new Object() {
			...
			world.setBlockState(new BlockPos((int) x, (int) y, (int) z), BlockFluorescentLampCaged.block.getDefaultState(), 3);
			try {
