...
public class BlockFLampBase extends BlockBase 
{
	public static final PropertyDirection FACING = BlockDirectional.FACING;
	protected final boolean isOn;
	public BlockFLampBase(String name, boolean isOn) 
	{
    ...
    public void randomDisplayTick(IBlockState stateIn, World worldIn, BlockPos pos, Random rand)
    {
        if (this.isOn)
        {
            ...
            {
            	worldIn.playSound((EntityPlayer) null, (double)pos.getX() + 0.5D, (double)pos.getY(), (double)pos.getZ() + 0.5D,SoundsHandler.FLUORESCENT_LAMP_BUZZ,SoundCategory.BLOCKS, 0.15F, 1.0F);
            }
        }
    }
}
