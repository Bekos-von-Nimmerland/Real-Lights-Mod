...
import su.workbench.reallights.block.BlockIncandescentLamp;
import su.workbench.reallights.ElementsRealLightsMod;

import java.util.Map;

@ElementsRealLightsMod.ModElement.Tag
public class ProcedureIncandescentLampOnRedstoneOff extends ElementsRealLightsMod.ModElement {
	public ProcedureIncandescentLampOnRedstoneOff(ElementsRealLightsMod instance) {
		super(instance, 10);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure IncandescentLampOnRedstoneOff!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure IncandescentLampOnRedstoneOff!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure IncandescentLampOnRedstoneOff!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure IncandescentLampOnRedstoneOff!");
			return;
		}
		...
		if (((new Object() {
			...
			world.setBlockState(new BlockPos((int) x, (int) y, (int) z), BlockIncandescentLamp.block.getDefaultState(), 3);
			try {
