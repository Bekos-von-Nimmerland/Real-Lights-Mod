...
import su.workbench.reallights.block.BlockLightBulbOn;
import su.workbench.reallights.ElementsRealLightsMod;

import java.util.Map;

@ElementsRealLightsMod.ModElement.Tag
public class ProcedureLightBulbRedstoneOn extends ElementsRealLightsMod.ModElement {
	public ProcedureLightBulbRedstoneOn(ElementsRealLightsMod instance) {
		super(instance, 15);
	}

	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			System.err.println("Failed to load dependency x for procedure LightBulbRedstoneOn!");
			return;
		}
		if (dependencies.get("y") == null) {
			System.err.println("Failed to load dependency y for procedure LightBulbRedstoneOn!");
			return;
		}
		if (dependencies.get("z") == null) {
			System.err.println("Failed to load dependency z for procedure LightBulbRedstoneOn!");
			return;
		}
		if (dependencies.get("world") == null) {
			System.err.println("Failed to load dependency world for procedure LightBulbRedstoneOn!");
			return;
		}
		...
		if (((new Object() {
			...
			world.setBlockState(new BlockPos((int) x, (int) y, (int) z), BlockLightBulbOn.block.getDefaultState(), 3);
			try {
