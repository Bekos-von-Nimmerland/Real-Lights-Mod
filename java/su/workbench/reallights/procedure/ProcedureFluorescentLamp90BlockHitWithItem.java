...
import su.workbench.reallights.block.BlockFluorescentLampCracked90;
...
public class ProcedureFluorescentLamp90BlockHitWithItem extends ElementsRealLightsMod.ModElement {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (((new Object() {
			...
			world.setBlockState(new BlockPos((int) x, (int) y, (int) z), BlockFluorescentLampCracked90.block.getDefaultState(), 3);
			try {
