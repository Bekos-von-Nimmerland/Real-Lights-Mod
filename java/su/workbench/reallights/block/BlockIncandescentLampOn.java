...
import su.workbench.reallights.procedure.ProcedureIncandescentLampOnRedstoneOff;
...
public class BlockIncandescentLampOn extends ElementsRealLightsMod.ModElement {
	@GameRegistry.ObjectHolder("real_lights:incandescent_lamp_on")
	public static final Block block = null;  
	public BlockIncandescentLampOn(ElementsRealLightsMod instance) {
		super(instance, 8);
	}

	@Override
	public void initElements() {
		elements.blocks.add(() -> new BlockCustom().setRegistryName("incandescent_lamp_on"));
	...
	public void registerModels(ModelRegistryEvent event) {
		ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0,
				new ModelResourceLocation("real_lights:incandescent_lamp_on", "inventory"));
	}
	public static class BlockCustom extends Block {
		public static final PropertyDirection FACING = BlockDirectional.FACING;
		public BlockCustom() {
			super(Material.REDSTONE_LIGHT);
			setUnlocalizedName("incandescent_lamp_on");
		...
		public void neighborChanged(IBlockState state, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos) {
			...
			if (world.isBlockIndirectlyGettingPowered(new BlockPos(x, y, z)) > 0) {
			} else {
				{
					...
					ProcedureIncandescentLampOnRedstoneOff.executeProcedure($_dependencies);
				}
			}
		}
